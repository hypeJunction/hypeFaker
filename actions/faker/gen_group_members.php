...
$groups = new ElggBatch('elgg_get_entities', array('types' => 'group', 'metadata_names' => '__faker', 'limit' => 0));
foreach ($groups as $group) {
    ...
    if (!$group->isPublicMembership()) {
        ...
        $invitees = elgg_get_entities(array('types' => 'user', 'limit' => $invites_count, 'order_by' => 'RAND()', 'metadata_names' => '__faker'));
        ...
        $requestors = elgg_get_entities(array('types' => 'user', 'limit' => $requests_count, 'order_by' => 'RAND()', 'metadata_names' => '__faker'));
