...
global $messages_pm;
$messages_pm = 1;
$senders = new ElggBatch('elgg_get_entities', ['types' => 'user', 'metadata_names' => '__faker', 'limit' => 0]);
...
if ($error) {
	elgg_register_success_message(elgg_echo('faker:gen_messages:error', [$success, $error]));
} else {
	elgg_register_success_message(elgg_echo('faker:gen_messages:success', [$success]));
}
